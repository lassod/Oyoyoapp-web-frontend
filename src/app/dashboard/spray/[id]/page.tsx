            ...
            <div className='flex rounded-2xl overflow-hidden bg-black flex-col'>
              ...
              <div className='flex flex-col gap-4'>
                <div className='relative'>
                  ...
                  <div ref={scrollRef} className='flex gap-4 overflow-x-auto scroll-smooth px-8 py-4 no-scrollbar'>
                          ...
                          {sprayOption === index && (
                            <>
                              <button
                                ...
                                onClick={() => setIsSpray({ ...item, symbol: wallet?.wallet?.symbol, id })}
                ...
                <div className='border-t px-4 py-6 flex flex-col md:flex-row gap-4 md:justify-between border-gray-600'>
                  <div className='space-y-1'>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <h6 className='text-white'>{wallet?.wallet?.cowrieBalance?.toLocaleString()}</h6>
                    </div>
                  </div>
                  <div className='flex items-center gap-2'>
