  ...
  return (
    <Dashboard className='flex flex-col bg-white gap-[10px] pb-20'>
      <div className='mx-auto max-w-4xl'>
        <div className='mb-8'>
          <h2 className='font-bold text-red-600 mb-2 text-balance'>Terms and Conditions for Oyoyo Event</h2>
        ...
        <div className='space-y-3 leading-relaxed rounded-xl shadow-md border p-2 sm:p-4 mb-10'>
        ...
        <div className='space-y-8'>
              ...
              <div>
                ...
                <div className='space-y-3'>
                  ...
                  <div>
                    ...
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Catwalk Creatives LTD, 2 Otunola
                    Adebayo Street Ilorin.
                  </div>
                  <div>
                  ...
                  <div>
                    <strong>Website</strong> refers to Oyoyo Event, accessible from{" "}
                    <a
                      href='http://event.oyoyoapp.com/'
                      target='_blank'
                      rel='noopener noreferrer'
                      className='text-red-600 hover:underline break-all'
                    >
                      http://event.oyoyoapp.com/
                    </a>
                  </div>
                  <div>
          ...
          <section>
            <h3 className='text-red-600 mb-4'>Links to Other Websites</h3>
            <p className='leading-relaxed'>
          ...
          {/* Termination */}
          <section>
            <h3 className='text-red-600 mb-4'>Termination</h3>
            <p className='leading-relaxed'>
          ...
          {/* "AS IS" Disclaimer */}
          <section>
            <h3 className='text-red-600 mb-4'>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h3>
            <div className='space-y-4'>
              <p>
          ...
          {/* Disputes Resolution */}
          <section>
            <h3 className='text-red-600 mb-4'>Disputes Resolution</h3>
            <p className='leading-relaxed'>
          ...
          {/* EU Users */}
          <section>
            <h3 className='text-red-600 mb-4'>For European Union (EU) Users</h3>
            <p className='leading-relaxed'>
          ...
          <section>
            <h3 className='text-red-600 mb-4'>Translation Interpretation</h3>
            <p className='leading-relaxed'>
          ...
          {/* Changes to Terms */}
          <section>
            <h3 className='text-red-600 mb-4'>Changes to These Terms and Conditions</h3>
            <div className='space-y-3'>
              <p>
          ...
          <div className='mt-12 pt-8 border-t'>
            <p className='text-xs text-center'>Generated using Privacy Policies Generator</p>
          </div>
        </div>
      </div>
    </Dashboard>
