...
const ViewListing = ({ params }: any) => {
  ...
  const { data: category } = useGetServiceCategoryById(
    service?.service_CategoryId
  );
  ...
  if (status !== "success") return <SkeletonCard2 />;
    ...
    return (
      <div className="relative mx-auto mt-36">
        <DashboardHeader>
          <DashboardHeaderText>
            {edit ? "Edit Listing" : "View Listing"}
          </DashboardHeaderText>
              ...
              <div className="flex mt-2 flex-col gap-4">
                <div className="flex flex-col grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="border rounded-lg p-4 flex flex-col gap-2">
                    ...
                    service?.Service_Plans[0].is_active ? (
                ...
                <div className="border rounded-lg p-4 flex flex-col gap-2">
                  <h4>Total Sales</h4>
                  <h6>
                    {service?.User?.currencySymbol}{" "}
                    {service?.Listing_ticket?.sales || 0}
                  </h6>
                </div>
              </div>
            </div>
