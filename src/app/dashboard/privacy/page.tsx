  ...
  return (
    <Dashboard className='flex flex-col bg-white gap-[10px] pb-20'>
      <div className='mx-auto max-w-4xl'>
        <div className='mb-8'>
          <h2 className=' text-red-600 mb-2 text-balance'>Privacy Policy for Oyoyo Event App</h2>
          <p className='text-muted-foreground'>Privacy Policy</p>
          <p className='text-muted-foreground'>Last updated: April 03, 2023</p>
        </div>
        ...
        <div className='space-y-8'>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <div className='space-y-3 '>
                  ...
                  <div>
                    <strong>Application</strong> refers to Oyoyo Event App, the software program provided by the
                    Company.
                  </div>
                  <div>
                    <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Lassod Consulting Limited, 142-143
                    Parrock Street Gravesend DA12 1EY..
                  </div>
                  <div>
          ...
          <section>
            <h3 className=' text-red-600 mb-4'>Collecting and Using Your Personal Data</h3>

            <div className='space-y-6 '>
              <div>
                <h3 className='text-lg font-medium mb-2'>Types of Data Collected</h3>
                <h4 className='font-medium mb-1'>Personal Data</h4>
                <p className='mb-2'>
              ...
              <div>
                <h4 className='font-medium mb-1'>Information Collected while Using the Application</h4>
                <p className='mb-2'>
                ...
                <p className='mb-2'>
                  ...
                  information may be uploaded to the Company&apos;s servers and/or a Service Provider&apos;s server or
                  it may be simply stored on Your device.
                </p>
          ...
          <section>
            <h3 className=' text-red-600 mb-4'>Use of Your Personal Data</h3>
            <div className='space-y-4 '>
          ...
          {/* Retention */}
          <section>
            <h3 className=' text-red-600 mb-4'>Retention of Your Personal Data</h3>
            <p className=' leading-relaxed'>
          ...
          {/* Transfer */}
          <section>
            <h3 className=' text-red-600 mb-4'>Transfer of Your Personal Data</h3>
            <div className='space-y-3 '>
              <p>
          ...
          {/* Delete */}
          <section>
            <h3 className=' text-red-600 mb-4'>Delete Your Personal Data</h3>
            <div className='space-y-3 '>
              <p>
          ...
          {/* Disclosure */}
          <section>
            <h3 className=' text-red-600 mb-4'>Disclosure of Your Personal Data</h3>
            <div className='space-y-4 '>
              <div>
          ...
          {/* Security */}
          <section>
            <h3 className=' text-red-600 mb-4'>Security of Your Personal Data</h3>
            <p className=' leading-relaxed'>
          ...
          {/* Children's Privacy */}
          <section>
            <h3 className=' text-red-600 mb-4'>Children&apos;s Privacy</h3>
            <div className='space-y-3 '>
              <p>
          ...
          {/* Changes */}
          <section>
            <h3 className=' text-red-600 mb-4'>Changes to this Privacy Policy</h3>
            <div className='space-y-3 '>
              <p>
          ...
          <section>
            ...
            <div className=' leading-relaxed'>
              ...
              <p className='mb-1'>
                By email:{" "}
                <a href='mailto:systems@lassod.com' className='text-red-600 hover:underline'>
                  systems@lassod.com
                </a>
              </p>
              <p>
                ...
                <a
                  href='https://lassod.com/contact-us/'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='text-red-600 hover:underline'
                >
                  https://lassod.com/contact-us/
                </a>
              </p>
            </div>
          </section>
