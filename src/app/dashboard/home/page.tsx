          ...
          <div>
            <div className="flex flex-col gap-10 pt-4 pb-10">
              {/* <div className='flex flex-col gap-1 '>
                ...
                <FilterMenu
                  type={1}
                  filterDateRange={filterOngoing}
                  placeholder={"Filter by Date"}
                  setFilterDateRange={setFilterOngoing}
                />
                    ...
                    <CarouselContent className='flex mt-4 relative gap-4 pb-4'>
                      {ongoingEvents.length > 0 ? (
                        ongoingEvents.map((item: any) => (
                          ...
                          >
                            <EventCard item={item} setEvent={setEvent} isFetching={isOngoingFetching} />
                          </CarouselItem>
                        ))
                      ) : (
                        <div className='flex flex-col items-center justify-center w-full h-[150px] gap-4'>
                          ...
                          <p className='text-[#666666] text-center'>No Ongoing Event</p>
                        </div>
                      )}
                    </CarouselContent>
                  </Carousel>
