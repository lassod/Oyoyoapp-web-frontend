...
export default function StripeKyc({
  cta = "Complete Stripe Verification",
}: Props) {
  ...
  useEffect(() => {
    if (onboardStatus)
      if (onboardStatus.onboardingStatus?.STRIPE) setOnboardCompleted(true);
  }, [onboardStatus]);
  ...
  return (
    <div className="flex flex-col gap-4 mt-10 mx-auto max-w-[480px]">
      ...
      <p className="text-sm text-muted-foreground">
        Verify your identity to withdraw your funds.
      </p>
            ...
            <AlertDialogHeader className="flex-row gap-4">
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                <p className="text-left text-sm text-muted-foreground">
                  You’ll be redirected to stripe.com to complete your
                  verification.
                </p>
              </div>
            </AlertDialogHeader>
