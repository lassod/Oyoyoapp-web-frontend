          ...
          {item.title === "Logout" ? (
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <div>
                  {state === "collapsed" ? (
                    <LogOut className='w-6 h-6 pl-1 ml-1 mt-2 cursor-pointer text-red-700' />
                  ) : (
                    <div className='flex gap-2 cursor-pointer hover:font-medium px-2 items-center text-red-700'>
